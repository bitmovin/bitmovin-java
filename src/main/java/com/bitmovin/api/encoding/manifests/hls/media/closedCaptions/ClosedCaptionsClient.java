...
public interface ClosedCaptionsClient {
    
    @RequestLine("POST /encoding/manifests/hls/{manifest_id}/media/closed-captions")
    ClosedCaptionsMediaInfo create(@Param("manifest_id") String manifestId, ClosedCaptionsMediaInfo closedCaptionsMediaInfo) throws BitmovinException;
    ...
    ClosedCaptionsMediaInfo get(@Param("manifest_id") String manifestId, @Param("media_id") String mediaId) throws BitmovinException;
    
    @RequestLine("GET /encoding/manifests/hls/{manifest_id}/media/closed-captions")
    List<ClosedCaptionsMediaInfo> list(@Param("manifest_id") String manifestId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
}
