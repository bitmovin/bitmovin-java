...
public interface PrimetimeClient {
    
    @RequestLine("POST /encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/primetime")
    PrimeTimeDrm create(@Param("encoding_id") String encodingId, @Param("muxing_id") String muxingId, PrimeTimeDrm primeTimeDrm) throws BitmovinException;
    ...
    PrimeTimeDrm get(@Param("encoding_id") String encodingId, @Param("muxing_id") String muxingId, @Param("drm_id") String drmId) throws BitmovinException;
    
    @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/primetime")
    List<PrimeTimeDrm> list(@Param("encoding_id") String encodingId, @Param("muxing_id") String muxingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
}
