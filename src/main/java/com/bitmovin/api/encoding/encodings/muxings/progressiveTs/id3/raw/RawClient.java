...
public interface RawClient {
    ...
    RawId3Tag create(@Param("encoding_id") String encodingId, @Param("muxing_id") String muxingId, RawId3Tag rawId3Tag) throws BitmovinException;
    ...
    RawId3Tag get(@Param("encoding_id") String encodingId, @Param("muxing_id") String muxingId, @Param("id3_tag_id") String id3TagId) throws BitmovinException;
    
    @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/id3/raw")
    List<RawId3Tag> list(@Param("encoding_id") String encodingId, @Param("muxing_id") String muxingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
}
