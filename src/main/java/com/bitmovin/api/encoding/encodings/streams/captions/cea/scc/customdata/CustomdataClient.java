...
public interface CustomdataClient {
    ...
    CustomData getCustomData(@Param("encoding_id") String encodingId, @Param("stream_id") String streamId, @Param("captions_id") String captionsId) throws BitmovinException;
}
