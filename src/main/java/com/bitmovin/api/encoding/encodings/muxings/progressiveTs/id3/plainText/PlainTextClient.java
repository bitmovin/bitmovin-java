...
public interface PlainTextClient {
    
    @RequestLine("POST /encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/id3/plain-text")
    PlaintextId3Tag create(@Param("encoding_id") String encodingId, @Param("muxing_id") String muxingId, PlaintextId3Tag plaintextId3Tag) throws BitmovinException;
    ...
    PlaintextId3Tag get(@Param("encoding_id") String encodingId, @Param("muxing_id") String muxingId, @Param("id3_tag_id") String id3TagId) throws BitmovinException;
    
    @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/id3/plain-text")
    List<PlaintextId3Tag> list(@Param("encoding_id") String encodingId, @Param("muxing_id") String muxingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
}
