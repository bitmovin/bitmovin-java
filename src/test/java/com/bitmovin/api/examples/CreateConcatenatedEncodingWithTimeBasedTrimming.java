...
public class CreateConcatenatedEncodingWithTimeBasedTrimming
{
    ...
    private static Double START_TIME = 10D;
    private static Double DURATION = 30D;
    ...
    public void testEncoding() throws IOException, BitmovinApiException, UnirestException, URISyntaxException, RestException, InterruptedException
    {
        ...
        timeBasedTrimmingInputStream.setInputStreamId(mainIngestStream.getId());
        timeBasedTrimmingInputStream.setOffset(START_TIME);
        timeBasedTrimmingInputStream.setDuration(DURATION);

        timeBasedTrimmingInputStream = bitmovinApi.encoding.timeBasedTrimmingInputStreamResource.addTimeBasedTrimmingInputStream(encoding, timeBasedTrimmingInputStream);
        ...
        mainConfig.setInputStreamId(timeBasedTrimmingInputStream.getId());
