 ...
 */
public class CreateEncodingWithHeAAC
{
    ...
    @Test
    public void testEncodingWithHeAAC() throws IOException, BitmovinApiException, UnirestException, URISyntaxException, RestException, InterruptedException
    {
        ...
        HeAACv1AudioConfig heAACv1Configuration = new HeAACv1AudioConfig();
        heAACv1Configuration.setBitrate(128000L);
        heAACv1Configuration.setRate(48000f);
        heAACv1Configuration = bitmovinApi.configuration.heAACv1.create(heAACv1Configuration);
        ...
        audioStream.setCodecConfigId(heAACv1Configuration.getId());
