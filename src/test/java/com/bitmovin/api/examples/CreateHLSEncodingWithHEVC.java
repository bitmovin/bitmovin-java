...
public class CreateHLSEncodingWithHEVC
{
            ...
            throws URISyntaxException, BitmovinApiException, RestException, UnirestException, IOException
    {
        ...
        h265VideoConfiguration.setName(name);
        h265VideoConfiguration.setDescription(name);
        h265VideoConfiguration.setProfile(profile);
        h265VideoConfiguration.setHeight(height);
        h265VideoConfiguration.setBitrate(bitRate);
        h265VideoConfiguration.setLevel(LevelH265.L1);
        h265VideoConfiguration.setQpMax(4);
        h265VideoConfiguration.setQpMin(1);
        h265VideoConfiguration.setMinBitrate(1000L);
        h265VideoConfiguration.setMaxBitrate(2L * bitRate);
