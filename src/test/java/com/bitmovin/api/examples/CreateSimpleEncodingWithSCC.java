...
public class CreateSimpleEncodingWithSCC
{
    ...
    public void testEncoding() throws IOException, BitmovinApiException, UnirestException, URISyntaxException, RestException, InterruptedException
    {
        ...
        this.bitmovinApi.encoding.stream.sccCaptions.create(encoding, videoStream240p, sccCaption);
        this.bitmovinApi.encoding.stream.sccCaptions.create(encoding, videoStream360p, sccCaption);
        this.bitmovinApi.encoding.stream.sccCaptions.create(encoding, videoStream480p, sccCaption);
        this.bitmovinApi.encoding.stream.sccCaptions.create(encoding, videoStream720p, sccCaption);
        this.bitmovinApi.encoding.stream.sccCaptions.create(encoding, videoStream1080p, sccCaption);
