 ...
 */
public class CreateEncodingWithStreamLanguage
{
    ...
    private static String LANGUAGE_CODE = "spa";
    ...
    public void testEncoding() throws IOException, BitmovinApiException, UnirestException, URISyntaxException, RestException, InterruptedException
    {
        ...
        encoding.setName("Encoding Java Example - Add Language Metadata to Audio Stream");
        ...
        streamMetadata.setLanguage(LANGUAGE_CODE);
        ...
        audioStream.setMetadata(streamMetadata);
        ...
        for (H264Representation representation: h264Representations)
        {
            ...
            this.createMP4Muxing(encoding, output, videoStream, audioStream, String.format("video_audio_%sp_%s.mp4", videoConfig.getHeight(), LANGUAGE_CODE));
        }
