...
public class CreateMp4EncodingAndKeyframeArchiveWithMP3Audio
{
    ...
    @Test
    public void testCreateMp4AndMovEncodingWithMp3() throws URISyntaxException, BitmovinApiException, UnirestException, IOException, RestException, InterruptedException
    {
        bitmovinApi = new BitmovinApi(API_KEY);

        Encoding encoding = new Encoding();
        encoding.setName("MP4 and MOV Encoding with MP3 Audio");
        encoding.setDescription("MP4 and MOV Encoding with MP3 Audio");
